(function () {
    ...
    function generate() {
        try {
            report = D.buildReport({ rows: NT_DATA.reports.rows, types: NT_DATA.reports.types, sites: NT_DATA.sites, user: NT.getUser(), filter: filter() }); const c = report.definition;
